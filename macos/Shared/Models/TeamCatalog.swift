...
enum TeamCatalog {
  ...
  private static let motoGPTeams: [TeamDefinition] = [
    ...
    .init(teamID:"motogp_ducati_mmarquez",   sport:.motoGP, city:"", name:"Ducati",  displayName:"Ducati",  abbreviation:"DUC", driverNames:["Marc Marquez", "M.Marquez"], espnTeamID:"motogp_ducati_lenovo", driverDisplayName:"Marc Marquez"),
    ...
    .init(teamID:"motogp_gresini_amarquez",  sport:.motoGP, city:"", name:"Gresini Racing", displayName:"Gresini Racing", abbreviation:"GRS", driverNames:["Alex Marquez", "A.Marquez"], espnTeamID:"motogp_gresini",       driverDisplayName:"Alex Marquez"),
